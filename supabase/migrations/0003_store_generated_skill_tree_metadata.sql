...
ADD COLUMN "is_checkpoint" boolean DEFAULT false NOT NULL,
ADD COLUMN "zone" text,
ADD COLUMN "zone_color" text,
ADD COLUMN "teaching_brief" text,
ADD COLUMN "position_z" real DEFAULT 0 NOT NULL;

CREATE OR REPLACE FUNCTION "public"."create_skill_tree_with_graph"(
  "p_tree_id" text,
  "p_subject" text,
  "p_goal" text,
  "p_nodes" jsonb,
