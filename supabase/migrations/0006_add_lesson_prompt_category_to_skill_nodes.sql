...
ADD COLUMN IF NOT EXISTS "generated_lesson" jsonb;

UPDATE "public"."skill_nodes"
SET "category" = 'technical_and_code'
WHERE "category" IS NULL
  OR "category" NOT IN ('math_and_logic', 'systems_and_economics', 'technical_and_code');

ALTER TABLE "public"."skill_nodes"
ALTER COLUMN "category" SET DEFAULT 'technical_and_code',
ALTER COLUMN "category" SET NOT NULL;

DO $$
BEGIN
  ALTER TABLE "public"."skill_nodes"
  ADD CONSTRAINT "skill_nodes_category_check"
  CHECK ("category" IN ('math_and_logic', 'systems_and_economics', 'technical_and_code'));
EXCEPTION
...
BEGIN
  ...
  SELECT
    ...
    COALESCE(node_record.category, 'technical_and_code'),
