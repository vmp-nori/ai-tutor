...
ADD COLUMN IF NOT EXISTS "is_checkpoint" boolean DEFAULT false NOT NULL,
ADD COLUMN IF NOT EXISTS "zone" text,
ADD COLUMN IF NOT EXISTS "zone_color" text,
ADD COLUMN IF NOT EXISTS "teaching_brief" text,
ADD COLUMN IF NOT EXISTS "position_z" real DEFAULT 0 NOT NULL;
