  ...
  if (awaitingConfirmation) {
    return (
      <main style={pageStyle}>
        <AuthLogo />
        <section aria-label="Check your email" style={panelStyle}>
          <h1 style={titleStyle}>Check your email</h1>
          <p style={copyStyle}>
            We sent a confirmation link to <strong>{email}</strong>. Open it to activate your account, then{" "}
  ...
  return (
    <main style={pageStyle}>
      ...
      <section aria-label="Create account" style={panelStyle}>
        ...
        <p style={copyStyle}>Sign up to start building your learning path.</p>
